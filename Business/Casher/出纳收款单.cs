...
{   
    public class 出纳收款单 : BaseDocument
    {

        public 出纳收款单() : base() { }
        public 出纳收款单(Guid OperatorId, string ModelUrl) : base(OperatorId, ModelUrl) { }
        ...
        public override JsonModel Save(string status, JsonModel jsonModel)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(strMsg))
                {
                    ...
                    OperatorLog.WriteLog(this.OperatorId, value, status, "出纳收款单", data);
            ...
            {
                OperatorLog.WriteLog(this.OperatorId, "出纳收款单", ex.Message, data, false);
                result.result = JsonModelConstant.Error;

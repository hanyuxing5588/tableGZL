...
{    
    public class 公务卡报销单 : BXDocument
    {
        public 公务卡报销单() : base() { }
        public 公务卡报销单(Guid OperatorId, string ModelUrl) : base(OperatorId, ModelUrl) { }
        ...
        public override JsonModel Save(string status, JsonModel jsonModel)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(strMsg))
                {
                    ...
                    OperatorLog.WriteLog(this.OperatorId, value, status, "公务卡报销单", data);
            ...
            {
                OperatorLog.WriteLog(this.OperatorId, "公务卡报销单", ex.Message, data, false);
                result.result = JsonModelConstant.Error;

...
{   
    public class 汇款审批单 : BXDocument
    {
        public 汇款审批单() : base() { }
        public 汇款审批单(Guid OperatorId, string ModelUrl) : base(OperatorId, ModelUrl) { }
        /// <summary>
        /// 创建默认值
        /// </summary>
        /// <returns></returns>
        ...
        protected override Guid Modify(JsonModel jsonModel)
        {
            ...
            BX_Detail mDetail = new BX_Detail();
            //客户信息在主表头上 在主表头中获取，并添加到明细项中              
            mDetail.Fill(jsonModel.m);
            ...
            else
            {
                ...
                foreach (BX_Detail detail in detailList)
                {
                    ...
                    else
                    {
                        ...
                        detail.GUID_Cutomer = mDetail.GUID_Cutomer;//客户信息（收款单位名称）
                       //CNPpaymentNumber 支付码
            ...
            if (jsonModel.d != null && jsonModel.d.Count > 0)
            {
                ...
                if (Grid != null)
                {
                    ...
                    foreach (List<JsonAttributeModel> row in Grid.r)
                    {
                        ...
                        temp.GUID_Cutomer = mDetail.GUID_Cutomer;//主表头上的客户信息（收款单位）
        ...
        public override JsonModel Save(string status, JsonModel jsonModel)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(strMsg))
                {
                    ...
                    OperatorLog.WriteLog(this.OperatorId, value, status, "汇款审批单", data);
            ...
            {
                OperatorLog.WriteLog(this.OperatorId, "汇款审批单", ex.Message, data, false);
                result.result = JsonModelConstant.Error;

...
{
    public class 临时工工资单:BXDocument
    {
       public 临时工工资单() : base() { }
       public 临时工工资单(Guid OperatorId, string ModelUrl) : base(OperatorId, ModelUrl) { }
       ...
       public override JsonModel Save(string status, JsonModel jsonModel)
       {
           ...
           try
           {
               ...
               if (string.IsNullOrEmpty(strMsg))
               {
                   ...
                   OperatorLog.WriteLog(this.OperatorId, value, status, "临时工工资单", data);
           ...
           {
               OperatorLog.WriteLog(this.OperatorId, "临时工工资单", ex.Message, data, false);
               result.result = JsonModelConstant.Error;

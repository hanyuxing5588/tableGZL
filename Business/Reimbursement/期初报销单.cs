...
{
    public class 期初报销单 : BaseDocument
    {
        public 期初报销单() : base() { }
        public 期初报销单(Guid OperatorId, string ModelUrl) : base(OperatorId, ModelUrl) { }
        /// <summary>
        /// 创建默认值
        /// </summary>
        /// <returns></returns>
        ...
        public override JsonModel Save(string status, JsonModel jsonModel)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(strMsg))
                {
                    ...
                    OperatorLog.WriteLog(this.OperatorId, value, status, "期初报销单", data);
            ...
            {
                OperatorLog.WriteLog(this.OperatorId, "期初报销单", ex.Message, data, false);
                result.result = JsonModelConstant.Error;

...
{   
    public class 内部调帐单 : BaseDocument
    {

        public 内部调帐单() : base() { }
        public 内部调帐单(Guid OperatorId, string ModelUrl) : base(OperatorId, ModelUrl) { }
        ...
        public override JsonModel Save(string status, JsonModel jsonModel)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(strMsg))
                {
                    ...
                    OperatorLog.WriteLog(this.OperatorId, value, status, "内部调帐单", data);
            ...
            {
                OperatorLog.WriteLog(this.OperatorId, "内部调帐单", ex.Message, data, false);
                result.result = JsonModelConstant.Error;

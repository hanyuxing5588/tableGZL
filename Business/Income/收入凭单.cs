...
namespace Business.Income
{
    ...
    public class 收入凭单 : BaseDocument
    {

        public 收入凭单() : base() { }
        public 收入凭单(Guid OperatorId, string ModelUrl) : base(OperatorId, ModelUrl) { }
        ...
        public override JsonModel Save(string status, JsonModel jsonModel)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(strMsg))
                {
                    ...
                    OperatorLog.WriteLog(this.OperatorId, value, status, "收入凭单", data);
            ...
            {
                OperatorLog.WriteLog(this.OperatorId, "收入凭单", ex.Message, data, false);
                result.result = JsonModelConstant.Error;

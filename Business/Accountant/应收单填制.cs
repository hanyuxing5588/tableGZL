...
{    
    public class 应收单填制 : BaseDocument
    {

        public 应收单填制() : base() { }
        public 应收单填制(Guid OperatorId, string ModelUrl) : base(OperatorId, ModelUrl) { }
        ...
        public override JsonModel Save(string status, JsonModel jsonModel)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(strMsg))
                {
                    ...
                    OperatorLog.WriteLog(this.OperatorId, value, status, "应收单填制", data);
            ...
            {
                OperatorLog.WriteLog(this.OperatorId, "应收单填制", ex.Message, data, false);
                result.result = JsonModelConstant.Error;

...
$(document).ready(function () {
    ...
    function loadData(id) {
        $.post('/JCjksz/GetPerson', { id: id }, function (data) {
    ...
    var SetPRalation = function (type) {
        ...
        $.ajax({
            ...
            data: { id: id, toformKey: toformID, compasrMainID: node.id, type: type, Ctype: 'Person', ClassID: '3' },
            error: function () {
...
function loadu8project(node, record) {
    $("#projectGrid").datagrid('load', { "extdb": node.attributes.ExteriorDataBase, "year": node.attributes.ExteriorYear, "prj": "Person" });
};

...
return false;
}},{title:"",width:250,height:200,showType:"slide",showSpeed:600,msg:"",timeout:4000},_263);
opts.style.zIndex=$.fn.window.defaults.zIndex++;
var win=$("<div class=\"messager-body\" style=\"overflow:auto;\"></div>").html(opts.msg).appendTo("body");//hanyx style=\"overflow:auto;\">
win.window(opts);
console(opts.style);
...
var win=$("<div class=\"messager-body\" style=\"overflow:auto;\"></div>").appendTo("body");//hanyx style=\"overflow:auto;\">
win.append(_266);
if(_267){
...
win.window({title:_265,noheader:(_265?false:true),width:300,height:h,modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
var _3cb=$("<input type=\"text\" readonly=\"readonly\" class=\"searchbox-text\">").appendTo(span);//hanyx  searchbox readonly=\"readonly\" 
...
var con = $.data(_4cd,"datagrid");//sxh
if (con==undefined)return;//sxh
var rows=con.data.rows;//sxh
var opts=con.options;//sxh
var dc=con.dc;//sxh
...
function _537(_538){
var con = $.data(_538,"datagrid");//sxh
if (con==undefined) return;//sxh
var dc=con.dc;//sxh
...
/*oao add cols*/
var dcols=(data||{}).columns;    
if(data &&dcols){
    var opts=$.data(_5dd, "datagrid").options;           
    var cols = $.data(_5dd, "datagrid").options.columns[0];      
    var colCount=cols.length;
    if(colCount==0){      
       for (var i = 0,j=dcols.length;i<j; i++) {  
           var dcol= dcols[i];   
           var col = {      
               field:dcol.field,      
               title:dcol.title,      
...
var con =$.data(jq[0],"datagrid");//sxh
if (con==undefined) return;//sxh
var _62f=con.options;//sxh
...
_660.push(this.renderRow.call(this,_65b,_65f,_65d,i,rows[i],hideRows?hideRows[i]:[]));/*oao*/
_660.push("</tr>");
}
}
/*oao clear hiderows*/
opts.hideRows=undefined;
/*oao end*/
...
//$(_666).html(_669.join(""));
    $(_666)[0].innerHTML=_669.join("");//hanyx 源码被注释 修改效率 为IE8
},
renderRow:function(_66a,_66b,_66c,_66d,_66e,_66z){/*oao _66z*/
...
cc.push(">");
if(col.checkbox){
    /*hanyx 修复 360下 checkbox 为true 选不中的bug*/
    if(_671!=undefined){
        cc.push("<input type=\"checkbox\" name=\""+_670+"\" checked=true  value=\""+_671+"\">");
    }else{
        cc.push("<input type=\"checkbox\" name=\""+_670+"\"   value=''>");
    }
}else{
if(col.formatter){
...
for (var i = 0; i < _67d.length; i++) {
    _tp67e[_67d[i]] = tr.find("td[field='" + _67d[i] + "']").find("div").attr("oaoValue");
}

tr.html(this.renderRow.call(this,_677,_67d,_67c,_678,rows[_678],_tp67e));
/***********/
...
if(data!=undefined && data!=null && data.length!=undefined && data.length!=null && typeof data.length=="number"&& data.splice && typeof data.splice=="function"){
...
_786=_786.concat(view.renderRow.call(view,_77b,_77e,_783,_784,row,i));
_786.push("</tr>");
...
_78f.push(this.renderRow.call(this,_78b,_78e,_78d,0,row,i));
_78f.push("</tr>");
}
_78f.push("</tbody></table>");
$(_78c).html(_78f.join(""));
},renderRow:function(_790,_791,_792,_793,row,rowIndex){//hanyx rowIndex
...
var val=null;
if(col.formatter){
val=col.formatter(row[_794],row,rowIndex);
}else{
val=row[_794];
}
...
_7c6.panel({doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onCloseEx:function(){
    var _7c7=$.data(_7c5,"combo");
    if(_7c7){
        _7c7.options.onCloseEx.call(_7c5);
    }
},onOpen:function(){
$(this).panel("resize");
},onClose:function(){
...
e.stopPropagation();
}).bind("keyup.combo",function(e){//为了模糊查询更精确
switch(e.keyCode){
case 38:
...
function _7d9(_7da){
var con = $.data(_7da,"combo");//sxh
if (con==undefined)return;//sxh
var opts=con.options;//sxh
var _7db=con.combo;//sxh
var _7dc=con.panel;//sxh
if($.fn.window){
...
var con = $.data(jq[0],"combo");//sxh
if (con==undefined) return;//sxh
return con.combo.find("input.combo-text");
},destroy:function(jq){
return jq.each(function(){
_7ce(this);
});
...
_885(this);
 ...
 var opts=$(this).combogrid("options");//hanyx
 if (opts==undefined)return;//sxh
 if(opts.query){//hanyx
    opts.query.call(this,q);//hanyx
 }else{//hanyx
    _882(this,q);
}//hanyx
}},filter:function(q,row){

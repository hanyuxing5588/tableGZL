...
win.window({title:_10,noheader:(_10?false:true),width:300,height:200,modal:true,overflow:'auto',collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});

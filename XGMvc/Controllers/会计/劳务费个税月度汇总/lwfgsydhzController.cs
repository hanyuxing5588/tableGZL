...
namespace BaothApp.Controllers.会计.劳务费个税月度汇总
{
    public class lwfgsydhzController : SpecificController
    {
        public override string ModelUrl
        {
            get { return "lwfgsydhz"; }
        }


        public override ViewResult Index()
        {
            return View("lwfgsydhz");
        }
        // 劳务费个税月度 汇总
        public ContentResult GetLoadlwfgsydhzHZData()
        {
            ...
            var report = new Business.Accountant.劳务费个税月度汇总(userGuid,this.ModelUrl);
        ...
        /// </summary>
        /// <returns></returns>
        public ContentResult GetLoadlwfgsydhzMXData()
        {
            string condition = Request["condition"];
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult ExportlwfgsydhzReport()
        {
            DataTable dt = new DataTable();
